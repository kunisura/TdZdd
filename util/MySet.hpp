 ...
 * $Id: MySet.hpp 518 2014-03-18 05:29:23Z iwashita $
 */
...
//    mutable bool sorted;
//    mutable T array[N == 0 ? 1 : N];
//
//    void sort() const {
//        if (sorted) return;
//        std::sort(array, array + size_);
//        size_ = std::unique(array, array + size_) - array;
//        sorted = true;
//    }
//
//public:
...
//     */
//    bool includes(T const& e) const {
//        return std::binary_search(array, array + size(), e);
//    }
//
//    /**
//     * Checks non-emptiness of the intersection of two bit-vectors.
...
//     * @return true if the intersection is not empty.
//     */
//    bool intersects(MySmallSet const& o) const {
//        T const* p = array;
//        T const* q = o.array;
//        T const* const pz = array + size();
//        T const* const qz = o.array + o.size();
//        while (p != pz && q != qz) {
//            if (*p == *q) return true;
//            if (*p < *q) ++p;
//            else ++q;
...
//    size_t hash() const {
//        size_t n = size();
//        size_t h = n * 314159257;
//        for (size_t i = 0; i < n; ++i) {
//            h += array[i].hash() * 314159257;
//        }
//        return h;
//    }
//
