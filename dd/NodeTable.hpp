 ...
 * $Id: NodeTable.hpp 518 2014-03-18 05:29:23Z iwashita $
 */
...
//    /**
//     * Get the entity.
//     * @return unmodifiable reference to the table.
//     */
//    NodeTableEntity<ARITY> const& entity() const {
//        return pointer->entity;
//    }
...
#ifdef DEBUG
            std::cerr << "NodeTableHandler::privateEntity()";
#endif
        }
        return pointer->entity;
    }
...
//template<typename T>
//class NodeProperty {
//    NodeTableEntity const& nodeTable;
//    DataTable<T> dataTable;
//
//public:
//    NodeProperty(NodeTableEntity const& nodeTable)
...
//            dataTable[i].resize(nodeTable[i].size());
//        }
//
//        return dataTable[i];
//    }
