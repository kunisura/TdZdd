 ...
 * $Id: ColoredZdd.hpp 518 2014-03-18 05:29:23Z iwashita $
 */
...
class ColoredZdd: public PodArrayDdSpec<ColoredZdd,NodeId> {
    ...
    int getLevel(NodeId const* a) const {
        int level = 0;
...
public:
    ColoredZdd(DdStructure const& dd, int colors)
